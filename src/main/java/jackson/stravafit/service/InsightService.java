...
public class InsightService {
    ...
    public String getActivityInsight(StravaActivity activity, List<StravaActivity.MinuteAnalysis> analysis) {
        return generateInsight(activity.getId(), activity.getName(), activity.distanceKm(), activity.getStartDateLocal(), activity.getAverageSpeed(), analysis);
    }
    ...
    private String generateInsight(Long activityId, String name, Double distance, String dateStr, Double averageSpeed, List<StravaActivity.MinuteAnalysis> analysis) {
        ...
        String prompt = buildProfessionalPrompt(name, distance, activityDate, averageSpeed, analysis, proximoTreinoData, prescricaoAnterior.orElse(null));
    ...
    private String buildProfessionalPrompt(String name, Double distance, ZonedDateTime date, Double averageSpeed, List<StravaActivity.MinuteAnalysis> analysis, String proximaData, WorkoutPrescriptionEntity prescricaoAnterior) {
        ...
        if (prescricaoAnterior != null) {
            ...
            sb.append("Data Agendada: ").append(prescricaoAnterior.getScheduledDate()).append("\n\n");
            sb.append("TAREFA ADICIONAL: Compare o treino executado com o prescrito e comente sobre a aderência do atleta ao plano.\n\n");
        }
        ...
        for (int i = 0; i < analysis.size(); i += 2) {
            ...
            sb.append(String.format("%d:%.0f/%.0fm/%.0f | ", m.getMinute(), m.getAverageHeartRate(), m.getAverageElevation(), m.getAverageCadence()));
        }

        sb.append("\n\n--- TAREFA PARA A IA ---\n");
        sb.append("1. Analise os 'DADOS DO TREINO ATUAL' e a 'SERIE TEMPORAL'.\n");
        sb.append("2. Com base na sua análise e na 'BASE DE CONHECIMENTO', identifique qual 'CENÁRIO' melhor descreve o treino executado.\n");
        sb.append("3. Construa a resposta final seguindo ESTRITAMENTE o formato abaixo, preenchendo os campos com a sua análise.\n\n");
        ...
        sb.append("1. ANÁLISE DE RITMO E COMPORTAMENTO CARDÍACO (Jacson):\n");
        ...
        sb.append("2. STATUS DO TREINO (CUMPRIMENTO DO PLANO):\n");
        ...
        sb.append("3. DIAGNÓSTICO TÉCNICO FISIOLÓGICO PARA Jacson:\n");
        sb.append("[BUSQUE NA 'BASE DE CONHECIMENTO' O CENÁRIO QUE VOCÊ IDENTIFICOU. TRANSCREVA AQUI O CONTEÚDO DO CAMPO 'DESCRIÇÃO' DAQUELE CENÁRIO, ADAPTANDO O TEXTO PARA FALAR DIRETAMENTE COM 'Jacson'.]\n\n");
        
        sb.append("4. CONCLUSÃO E PRÓXIMO PASSO PARA Jacson:\n");
        ...
        sb.append("--- PRESCRIÇÃO STRAFIT PREDICT PARA ").append(proximaData.toUpperCase()).append(" ---\n");
        ...
        sb.append("5. NUTRIÇÃO CONTEXTUAL\n");
        sb.append("[PREENCHA AQUI COM AS RECOMENDAÇÕES NUTRICIONAIS PÓS-TREINO E DE SUPLEMENTAÇÃO]\n");
